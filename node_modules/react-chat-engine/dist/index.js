...
var Websocket = _interopDefault(require('react-websocket'));
...
var Socket = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Websocket, {
...
var ChatForm = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.handleSubmit = function handleSubmit(event) {
    ...
    if (this.state.value.trim().length > 0) {
      reactChatEngine.newChat(this.props.creds, {
...
var ChatList = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderChats = function renderChats(chats) {
    ...
    return _.map(chats, function (chat, index) {
      ...
      }, chat.title, ' ', !_this.readLastMessage(_this.props, chat) && /*#__PURE__*/React__default.createElement("div", {
      ...
      }, chat.last_message.text ? chat.last_message.text : 'Say hello!'), /*#__PURE__*/React__default.createElement("div", {
  ...
  _proto.render = function render() {
    ...
    }, this.renderChats(this.props.chats), /*#__PURE__*/React__default.createElement("div", {
      style: {
        height: '64px'
      }
    ...
    }, /*#__PURE__*/React__default.createElement(ChatForm, {
      creds: this.props,
...
var Title = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      className: "ce-chat-title-text"
    }, chat && chat.title), /*#__PURE__*/React__default.createElement("div", {
...
var Loading = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    return /*#__PURE__*/React__default.createElement(icons.LoadingOutlined, {
      style: {
        width: '100%',
        position: 'relative',
        top: 'calc(50% - 26px)',
...
var TheirMessage = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, (!lastMessage || lastMessage.sender.username !== message.sender.username) && /*#__PURE__*/React__default.createElement("div", {
      style: styles$b.nameText,
      className: "ce-their-message-sender"
    }, this.renderPersonText(message.sender)), /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
      style: {
        paddingLeft: '2px'
      },
    ...
    }, (!nextMessage || nextMessage.sender.username !== message.sender.username) && /*#__PURE__*/React__default.createElement(Avatar, {
...
var Message$1 = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }), message.sender.username == creds.userName ? /*#__PURE__*/React__default.createElement(Message, {
      chat: chat,
      creds: creds,
...
var MessageForm = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.handleChange = function handleChange(event) {
    ...
    reactChatEngine.isTyping(this.props.creds, this.props.chatId);
  };
  ...
  _proto.handleSubmit = function handleSubmit(event) {
    ...
    if (text.length > 0 || files.length > 0) {
      reactChatEngine.sendMessage(this.props.creds, this.props.chatId, {
        text: text,
        files: files
      }, function (data) {});
    }
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(TextAreaInput, {
      value: this.state.value,
...
var ChatFeed = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, this.props.renderChatHeader ? this.props.renderChatHeader(chat) : /*#__PURE__*/React__default.createElement(Title, {
      chat: chat
    }), /*#__PURE__*/React__default.createElement("div", {
    ...
    }), this.renderMessages(), this.renderTypers(), /*#__PURE__*/React__default.createElement("div", {
      style: {
        height: '54px'
      },
      className: "ce-feed-container-bottom"
    })), this.props.renderNewMessageForm ? this.props.renderNewMessageForm(this.props, activeChat) : /*#__PURE__*/React__default.createElement(MessageForm, {
      creds: this.props,
      chatId: activeChat
    }));
  };
...
var PeopleList = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }), this.renderChatPeople(chat.people), /*#__PURE__*/React__default.createElement("div", {
      style: {
        height: '12px'
      }
    }), creds && chat && creds.userName === chat.admin.username && /*#__PURE__*/React__default.createElement(PersonForm, {
      creds: creds,
      chat: chat
    })));
  };
...
var Options = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      icon: "delete",
      onClick: function onClick() {
        return reactChatEngine.deleteChat(creds, chat.id, function (data) {});
      },
      style: {
        width: '100%',
        marginBottom: '12px'
...
var ChatSettings = /*#__PURE__*/function (_Component) {
  ...
  _proto.renderOnePerson = function renderOnePerson(people) {
    return /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
      xs: 6,
      style: {
        paddingTop: '22px',
        height: '80px'
  ...
  _proto.render = function render() {
    ...
    }, /*#__PURE__*/React__default.createElement(reactGridSystem.Row, {
      className: "ce-chat-avatars-row"
    }, /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
      xs: 3
    }), topPeople.length == 1 && this.renderOnePerson(topPeople), topPeople.length == 2 && this.renderTwoPeople(topPeople), topPeople.length == 3 && this.renderThreePeople(topPeople), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
      xs: 3
    })), /*#__PURE__*/React__default.createElement(MessageForm$1, {
      chat: chat,
      creds: creds
    }));
  };
...
var ChatSettingsContainer = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, this.props.renderChatSettingsTop ? this.props.renderChatSettingsTop(this.props, chat) : /*#__PURE__*/React__default.createElement(ChatSettings, {
      creds: this.props,
      chat: chat
    }), this.props.renderPeopleSettings ? this.props.renderPeopleSettings(this.props, chat) : /*#__PURE__*/React__default.createElement(PeopleList, {
      creds: this.props,
      chat: chat
    }), this.props.renderPhotosSettings ? this.props.renderPhotosSettings(chat) : /*#__PURE__*/React__default.createElement(Photos, {
      chat: chat
    }), this.props && chat && this.props.userName === chat.admin.username && /*#__PURE__*/React__default.createElement("div", null, this.props.renderOptionsSettings ? this.props.renderOptionsSettings(this.props, chat) : /*#__PURE__*/React__default.createElement(Options, {
      creds: this.props,
      chat: chat
    }))));
  };
...
var App = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, this.props.renderChatList ? this.props.renderChatList(_extends({}, this.props, this.state)) : /*#__PURE__*/React__default.createElement(ChatList, _extends({}, this.props, this.state, {
    ...
    }, this.props.renderChatFeed ? this.props.renderChatFeed(_extends({}, this.props, this.state)) : /*#__PURE__*/React__default.createElement(ChatFeed, _extends({}, this.props, this.state))), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
      xs: 0,
      sm: 3,
      style: {
        height: height ? height : ''
